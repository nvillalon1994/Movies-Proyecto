                ...
                {({errors,isSubmitting})=>{
                    return <section >
                        <Form className=' bg-violet-400 w-11/12 md:w-1/2 p-5 md:p-10 mx-auto mt-20 shadow-xl shadow-black rounded-t-lg'>
                            {isLogin?<h2 className=' text-center font-bold text-5xl mb-10'>Inicia sesión</h2>:<h2 className=' text-center font-bold text-5xl mb-10'>Registrate</h2>}
                            {isLogin?<div className='flex flex-col md:w-1/2 mx-auto gap-5'>
                                ...
                                <button type='submit' className={`bg-violet-600 p-3 rounded-md text-white hover:text-shadow-lg hover:shadow-lg hover:bg-color4-comentarios ${isSubmitting&&"bg-red-500"}`}>Iniciar sesión</button>
